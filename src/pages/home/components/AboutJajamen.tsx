      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start mb-8 md:mb-16">
          ...
          <div className="flex flex-col gap-4 md:gap-6 items-center">
            ...
            <p style={{ color: '#44413C', fontFamily: '"Yu Mincho Pr6N M", "Yu Mincho", "YuMincho", serif', maxWidth: '584px' }} className="text-base md:text-lg lg:text-xl leading-relaxed md:leading-loose">
